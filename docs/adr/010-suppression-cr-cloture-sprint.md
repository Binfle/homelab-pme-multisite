...
Le binôme travaille en stream Discord permanent. Les décisions structurantes vont en ADR, les procédures opérationnelles vont en `installations/` et `runbooks/`, les détails du quotidien vont en commits avec message Conventional Commits. Toute information utile est déjà tracée atomiquement.
